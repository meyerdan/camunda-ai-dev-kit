...
- pom.xml → Java: use `@JobWorker(type = "...")` pattern from `${CLAUDE_PLUGIN_ROOT}/docs/lang-java.md`
- package.json → Node.js: use `zeebe.createWorker()` pattern from `${CLAUDE_PLUGIN_ROOT}/docs/lang-nodejs.md`
